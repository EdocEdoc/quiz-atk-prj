...
function RoomPage() {
  ...
  return (
    <div className="min-h-screen min-w-screen mx-auto px-4 py-8">
      <div className="max-w-6xl mx-auto">
        {/* Header */}
        <div className="flex flex-col items-center justify-between md:mb-8 gap-8 wrap-normal overflow-auto md:flex-row">
          <Button
            onClick={() => navigate("/")}
            variant="outline"
          ...
          <Card className="p-6">
            <div className="flex">
              ...
              <div className="flex-1 pl-8">
                <label className="block text-gray-300 text-sm mb-2 text-end">
                  HP
                </label>
